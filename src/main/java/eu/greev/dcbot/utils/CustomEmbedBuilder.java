...
public class CustomEmbedBuilder
{
    ...
    private boolean configColor = true;

    /**
     * Constructs a new EmbedBuilderExtension instance, which can be used to create {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbeds}.
    ...
    /**
     * Creates an EmbedBuilderExtension using fields from an existing builder
     *
     * @param  builder
     *         the existing builder
     */
    public CustomEmbedBuilder(@Nullable CustomEmbedBuilder builder)
    {
        copyFrom(builder);
    }

    /**
     * Creates an EmbedBuilderExtension using fields in an existing embed.
     *
     * @param  embed
     *         the existing embed
     */
    public CustomEmbedBuilder(@Nullable MessageEmbed embed)
    {
        copyFrom(embed);
    }
     ...
     */
    @NotNull
    public static CustomEmbedBuilder fromData(@NotNull DataObject data)
    {
    ...
    public CustomEmbedBuilder serverFooter() {
        this.setFooter("$SERVER_NAME", "$SERVER_LOGO");
        return this;
    }

    public CustomEmbedBuilder userAuthor() {
        this.setAuthor("$USER_NAME", null, "$USER_AVATAR");
        return this;
    }

    public void placeholder(String key, String value) {
        this.placeholders.put(key.toUpperCase(), value);
    }

    /**
     * Builds the CustomEmbedBuilder, replacing all placeholders and applying defined options, like using the config color.
     * @return The built MessageEmbed with all placeholders replaced
     */
    @NotNull
    public MessageEmbed build() {
        final String description = this.description.isEmpty() ? null : this.description.toString();
        return EntityBuilder.createMessageEmbed(
                ...
                EmbedType.RICH,
                timestamp,
                this.configColor ? getConfigColor() : color,
                thumbnail,
                null,
                replacePlaceholders(author),
                null,
                replacePlaceholders(footer),
                image,
                fields.stream().map(this::replacePlaceholders).toList()
        );
    }

    @Nullable
    private MessageEmbed.Footer replacePlaceholders(@Nullable MessageEmbed.Footer footer) {
        return footer == null ? null : new MessageEmbed.Footer(
                replacePlaceholders(footer.getText()),
                replacePlaceholders(footer.getIconUrl()),
                replacePlaceholders(footer.getProxyIconUrl())
        );
    }

    @Nullable
    private MessageEmbed.AuthorInfo replacePlaceholders(@Nullable MessageEmbed.AuthorInfo author) {
        return author == null ? null : new MessageEmbed.AuthorInfo(
                replacePlaceholders(author.getName()),
                replacePlaceholders(author.getUrl()),
                replacePlaceholders(author.getIconUrl()),
                replacePlaceholders(author.getProxyIconUrl())
        );
    }

    @NotNull
    private MessageEmbed.Field replacePlaceholders(@NotNull MessageEmbed.Field field) {
        return new MessageEmbed.Field(
                replacePlaceholders(field.getName()),
    ...
    @Nullable
    private String replacePlaceholders(@Nullable String string) {
        if(string == null) return null;
        MutableString mutable = MutableString.of(string);
        placeholders.forEach((k, v) -> mutable.set(mutable.get().replace(k, v)));
        return mutable.get();
    }

    private int getConfigColor() {
        return Optional.ofNullable(placeholders.get("$CONFIG_COLOR")).map(s -> Color.decode(s).getRGB()).orElse(this.color);
    }
     ...
     *
     * @return The current EmbedBuilderExtension with default values
     */
    @NotNull
    public CustomEmbedBuilder clear()
    {
     ...
     *         the existing builder
     */
    public void copyFrom(@Nullable CustomEmbedBuilder builder)
    {
        if (builder != null)
        {
            ...
            this.placeholders.putAll(builder.placeholders);
            this.configColor = builder.configColor;
        }
    }
    ...
    /**
     * The overall length of the current EmbedBuilderExtension in displayed characters.
     ...
     */
    @NotNull
    public CustomEmbedBuilder setTitle(@Nullable String title)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setTitle(@Nullable String title, @Nullable String url)
    {
        if (title == null)
        {
            this.title = null;
     ...
     */
    @NotNull
    public CustomEmbedBuilder setUrl(@Nullable String url)
    {
        if (Helpers.isBlank(url))
            url = null;
        this.url = url;
     ...
     */
    @NotNull
    public final CustomEmbedBuilder setDescription(@Nullable CharSequence description)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder appendDescription(@NotNull CharSequence description)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setTimestamp(@Nullable TemporalAccessor temporal)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setColor(@Nullable Color color)
    {
     ...
     * EmbedBuilderExtension embed = new EmbedBuilderExtension();
     ...
     */
    @NotNull
    public CustomEmbedBuilder setThumbnail(@Nullable String url)
    {
        if (url == null)
        {
            this.thumbnail = null;
     ...
     */
    @NotNull
    public CustomEmbedBuilder setImage(@Nullable String url)
    {
        if (url == null)
        {
            this.image = null;
     ...
     */
    @NotNull
    public CustomEmbedBuilder setAuthor(@Nullable String name)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setAuthor(@Nullable String name, @Nullable String url)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setAuthor(@Nullable String name, @Nullable String url, @Nullable String iconUrl)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setFooter(@Nullable String text)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder setFooter(@Nullable String text, @Nullable String iconUrl)
    {
     ...
     */
    @NotNull
    public CustomEmbedBuilder addField(@Nullable MessageEmbed.Field field)
    {
     ...
     * with {@link CustomEmbedBuilder#ZERO_WIDTH_SPACE}.
     *
     ...
     */
    @NotNull
    public CustomEmbedBuilder addField(@NotNull String name, @NotNull String value, boolean inline)
    {
     ...
     * {@link CustomEmbedBuilder#CustomEmbedBuilder(net.dv8tion.jda.api.entities.MessageEmbed) EmbedBuilderExtension(MessageEmbed)}
     * constructor or via the
     * {@link CustomEmbedBuilder#addField(net.dv8tion.jda.api.entities.MessageEmbed.Field) addField} methods.
     *
     * @return the builder after the field has been added
     */
    @NotNull
    public CustomEmbedBuilder clearFields()
    {
        this.fields.clear();
        return this;
    }
